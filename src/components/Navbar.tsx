...
>
    ...
    >
      ...
      >
        ...
        <ul className="absolute hidden group-hover:flex flex-col bg-white shadow-lg rounded-md  min-w-[150px] z-10">
          ...
          <li><a href="/checkout" className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-100">checkout</a></li>
  ...
  <li className="max-lg:border-b max-lg:py-3 px-3">
    <a href="/blogpage" className="text-white hover:text-[#007bff] text-[15px] block font-semibold">
      Blog
    </a>
  </li>
  <li className="max-lg:border-b max-lg:py-3 px-3">
    <a href="/shoplist" className="text-white hover:text-[#007bff] text-[15px] block font-semibold">
      Shop
    </a>
  </li>
  <li className="max-lg:border-b max-lg:py-3 px-3">
    <a href="/signin" className="text-white hover:text-[#007bff] text-[15px] block font-semibold">
      Contact
    </a>
  </li>
</ul>
